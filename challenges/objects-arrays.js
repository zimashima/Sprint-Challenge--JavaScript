...
dinoOne.roar = () => `RAWERSRARARWERSARARARRRR!`
...
unisWithUni = graduates.filter(grad => grad.university.includes('Uni'))
...
populationTotal = zooAnimals.reduce((accumulator, animal) => {animal.population + accumulator},0)
